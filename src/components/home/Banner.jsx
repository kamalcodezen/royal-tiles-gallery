      ...
      >
        ...
        <SwiperSlide>
          <div className="relative h-screen">
            ...
            {/* Content */}
            <div className="relative z-10 flex items-end md:items-center justify-center md:justify-start h-full px-5 md:px-16 pb-52 md:pt-70">
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="relative z-10 flex items-end justify-center md:justify-center h-full px-5 md:px-16 pb-52 md:pb-28 ">
        ...
        <SwiperSlide>
          ...
          >
            ...
            <div className="relative z-10 flex items-end justify-center md:justify-center h-full px-5 md:px-16 pb-52 md:pb-28 text-center">
